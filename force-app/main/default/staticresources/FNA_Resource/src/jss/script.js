...
jQuery(document).ready(function ($) {
    ...
    var download = function () {
        ...
        var reset = function () {
            $('#otpLabel, #otpInput, #sendOTP, #resendOTP, .modal-dialog .success, button#finish').hide();
...
$(window).on('load', function () {
	...
	/*if((navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/iPod/i)) || (height <= 480 && width <= 480) ) {
