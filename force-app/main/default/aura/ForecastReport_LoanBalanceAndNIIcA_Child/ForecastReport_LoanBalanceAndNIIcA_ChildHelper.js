...
setValueTarget: function (component, helper, niBal, totalTarget) {
  ...
  if(month >= 9) {
      if(totalTarget.thirdTargetFYTarget === '') {
          ...
          niBal.thirdTargetVarianceFull = (month == 0) ? 0 : niBal.ytd - (totalTarget.thirdTargetFYTarget/12 * month)
    ...
    if(element != null && element.product == rowType[2]) {
      ...
      if (keyword == 'NI') {
        if(element != null && element.product == rowType[3]) {
          valueArr[3].lastYearMillionUnit = (valueArr[3].lastYear / 10 ** 6).toFixed(2)
          valueArr[3].janMillionUnit = (valueArr[3].jan / 10 ** 6).toFixed(2)
          valueArr[3].febMillionUnit = (valueArr[3].feb / 10 ** 6).toFixed(2)
          valueArr[3].marMillionUnit = (valueArr[3].mar / 10 ** 6).toFixed(2)
          valueArr[3].aprMillionUnit = (valueArr[3].apr / 10 ** 6).toFixed(2)
          valueArr[3].mayMillionUnit = (valueArr[3].may / 10 ** 6).toFixed(2)
          valueArr[3].junMillionUnit = (valueArr[3].jun / 10 ** 6).toFixed(2)
          valueArr[3].julMillionUnit = (valueArr[3].jul / 10 ** 6).toFixed(2)
          valueArr[3].augMillionUnit = (valueArr[3].aug / 10 ** 6).toFixed(2)
          valueArr[3].sepMillionUnit = (valueArr[3].sep / 10 ** 6).toFixed(2)
          valueArr[3].octMillionUnit = (valueArr[3].oct / 10 ** 6).toFixed(2)
          valueArr[3].novMillionUnit = (valueArr[3].nov / 10 ** 6).toFixed(2)
          valueArr[3].decMillionUnit = (valueArr[3].dec / 10 ** 6).toFixed(2)
          valueArr[3].totalMillionUnit = (valueArr[3].total / 10 ** 6).toFixed(2)
          valueArr[3].ytdMillionUnit = (valueArr[3].ytd == 0 || valueArr[3].ytd == '') ? valueArr[3].ytd : (valueArr[3].ytd / 10 ** 6).toFixed(2);

          if(valueArr[3].ytd === '') {
              valueArr[3].yoy = ''
              valueArr[3].yoyMillionUnit = ''
          } else {
              valueArr[3].yoy = (valueArr[3].ytd == 0 || valueArr[3].lastYearActual == 0) ? 0 : ((valueArr[3].ytd / valueArr[3].lastYearActual) * 100);
              valueArr[3].yoyMillionUnit = (valueArr[3].ytd == 0 || valueArr[3].lastYearActual == 0) ? 0 : (valueArr[3].ytd / valueArr[3].lastYearActual);
          }
          jsonForCSV = jsonForCSV.concat(helper.setJSONData(component, helper, valueArr[3]))
        }
        if(element != null && element.product == rowType[4]) {
          valueArr[4].lastYearMillionUnit = (valueArr[4].lastYear / 10 ** 6).toFixed(2)
          valueArr[4].janMillionUnit = (valueArr[4].jan / 10 ** 6).toFixed(2)
          valueArr[4].febMillionUnit = (valueArr[4].feb / 10 ** 6).toFixed(2)
          valueArr[4].marMillionUnit = (valueArr[4].mar / 10 ** 6).toFixed(2)
          valueArr[4].aprMillionUnit = (valueArr[4].apr / 10 ** 6).toFixed(2)
          valueArr[4].mayMillionUnit = (valueArr[4].may / 10 ** 6).toFixed(2)
          valueArr[4].junMillionUnit = (valueArr[4].jun / 10 ** 6).toFixed(2)
          valueArr[4].julMillionUnit = (valueArr[4].jul / 10 ** 6).toFixed(2)
          valueArr[4].augMillionUnit = (valueArr[4].aug / 10 ** 6).toFixed(2)
          valueArr[4].sepMillionUnit = (valueArr[4].sep / 10 ** 6).toFixed(2)
          valueArr[4].octMillionUnit = (valueArr[4].oct / 10 ** 6).toFixed(2)
          valueArr[4].novMillionUnit = (valueArr[4].nov / 10 ** 6).toFixed(2)
          valueArr[4].decMillionUnit = (valueArr[4].dec / 10 ** 6).toFixed(2)
          valueArr[4].totalMillionUnit = (valueArr[4].total / 10 ** 6).toFixed(2)
          valueArr[4].ytdMillionUnit = (valueArr[4].ytd == 0 || valueArr[4].ytd == '') ? valueArr[4].ytd : (valueArr[4].ytd / 10 ** 6).toFixed(2);

          if(valueArr[4].ytd === '') {
              valueArr[4].yoy = ''
              valueArr[4].yoyMillionUnit = ''
          } else {
              valueArr[4].yoy = (valueArr[4].ytd == 0 || valueArr[4].lastYearActual == 0) ? 0 : ((valueArr[4].ytd / valueArr[4].lastYearActual) * 100);
              valueArr[4].yoyMillionUnit = (valueArr[4].ytd == 0 || valueArr[4].lastYearActual == 0) ? 0 : (valueArr[4].ytd / valueArr[4].lastYearActual);
          }
          jsonForCSV = jsonForCSV.concat(helper.setJSONData(component, helper, valueArr[4]))
        }
      }
    }
  });
...
calLTPortion: function (component, helper, LTPortion, endingBal) {
  var jsonForCSV = component.get('v.jsonForCSV')
  LTPortion[0].lastYear = (endingBal[1].lastYear == 0 || endingBal[0].lastYear == 0) ? 0 : (endingBal[1].lastYear / endingBal[0].lastYear) * 100
  LTPortion[0].jan = (endingBal[1].jan == 0 || endingBal[0].jan == 0) ? 0 : (endingBal[1].jan / endingBal[0].jan) * 100
  LTPortion[0].feb = (endingBal[1].feb == 0 || endingBal[0].feb == 0) ? 0 : (endingBal[1].feb / endingBal[0].feb) * 100
  LTPortion[0].mar = (endingBal[1].mar == 0 || endingBal[0].mar == 0) ? 0 : (endingBal[1].mar / endingBal[0].mar) * 100
  LTPortion[0].apr = (endingBal[1].apr == 0 || endingBal[0].apr == 0) ? 0 : (endingBal[1].apr / endingBal[0].apr) * 100
  LTPortion[0].may = (endingBal[1].may == 0 || endingBal[0].may == 0) ? 0 : (endingBal[1].may / endingBal[0].may) * 100
  LTPortion[0].jun = (endingBal[1].jun == 0 || endingBal[0].jun == 0) ? 0 : (endingBal[1].jun / endingBal[0].jun) * 100
  LTPortion[0].jul = (endingBal[1].jul == 0 || endingBal[0].jul == 0) ? 0 : (endingBal[1].jul / endingBal[0].jul) * 100
  LTPortion[0].aug = (endingBal[1].aug == 0 || endingBal[0].aug == 0) ? 0 : (endingBal[1].aug / endingBal[0].aug) * 100
  LTPortion[0].sep = (endingBal[1].sep == 0 || endingBal[0].sep == 0) ? 0 : (endingBal[1].sep / endingBal[0].sep) * 100
  LTPortion[0].oct = (endingBal[1].oct == 0 || endingBal[0].oct == 0) ? 0 : (endingBal[1].oct / endingBal[0].oct) * 100
  LTPortion[0].nov = (endingBal[1].nov == 0 || endingBal[0].nov == 0) ? 0 : (endingBal[1].nov / endingBal[0].nov) * 100
  LTPortion[0].dec = (endingBal[1].dec == 0 || endingBal[0].dec == 0) ? 0 : (endingBal[1].dec / endingBal[0].dec) * 100
  LTPortion[0].total = (endingBal[1].total == 0 || endingBal[0].total == 0) ? 0 : (endingBal[1].total / endingBal[0].total) * 100
  LTPortion[0].lastYearActual = (endingBal[1].lastYearActual == 0 || endingBal[0].lastYearActual == 0) ? 0 : (endingBal[1].lastYearActual / endingBal[0].lastYearActual) * 100

  if(endingBal[1].ytd === '' || endingBal[0].ytd === '') {
    LTPortion[0].ytd = ''
    LTPortion[0].yoy = ''
  } else {
    LTPortion[0].ytd = (endingBal[1].ytd == 0 || endingBal[0].ytd == 0) ? 0 : (endingBal[1].ytd / endingBal[0].ytd) * 100
    LTPortion[0].yoy = (LTPortion[0].ytd == 0 || LTPortion[0].lastYearActual == 0) ? '' : ((LTPortion[0].ytd / LTPortion[0].lastYearActual) * 100)
  }
  
  LTPortion[0].lastYearMillionUnit = LTPortion[0].lastYear == 0 ? 0 : LTPortion[0].lastYear / 100
  LTPortion[0].janMillionUnit = LTPortion[0].jan == 0 ? 0 : LTPortion[0].jan / 100
  LTPortion[0].febMillionUnit = LTPortion[0].feb == 0 ? 0 : LTPortion[0].feb / 100
  LTPortion[0].marMillionUnit = LTPortion[0].mar == 0 ? 0 : LTPortion[0].mar / 100
  LTPortion[0].aprMillionUnit = LTPortion[0].apr == 0 ? 0 : LTPortion[0].apr / 100
  LTPortion[0].mayMillionUnit = LTPortion[0].may == 0 ? 0 : LTPortion[0].may / 100
  LTPortion[0].junMillionUnit = LTPortion[0].jun == 0 ? 0 : LTPortion[0].jun / 100
  LTPortion[0].julMillionUnit = LTPortion[0].jul == 0 ? 0 : LTPortion[0].jul / 100
  LTPortion[0].augMillionUnit = LTPortion[0].aug == 0 ? 0 : LTPortion[0].aug / 100
  LTPortion[0].sepMillionUnit = LTPortion[0].sep == 0 ? 0 : LTPortion[0].sep / 100
  LTPortion[0].octMillionUnit = LTPortion[0].oct == 0 ? 0 : LTPortion[0].oct / 100
  LTPortion[0].novMillionUnit = LTPortion[0].nov == 0 ? 0 : LTPortion[0].nov / 100
  LTPortion[0].decMillionUnit = LTPortion[0].dec == 0 ? 0 : LTPortion[0].dec / 100
  LTPortion[0].totalMillionUnit = LTPortion[0].total == 0 ? 0 : LTPortion[0].total / 100
  if(LTPortion[0].ytd === '') {
    LTPortion[0].ytdMillionUnit = ''
    LTPortion[0].yoyMillionUnit = ''
  } else {
    LTPortion[0].ytdMillionUnit = LTPortion[0].ytd == 0 ? 0 : LTPortion[0].ytd / 100
    LTPortion[0].yoyMillionUnit = (LTPortion[0].ytd == 0 || LTPortion[0].lastYearActual == 0) ? 0 : LTPortion[0].ytd / LTPortion[0].lastYearActual
  }
  
  jsonForCSV = jsonForCSV.concat(helper.setJSONData(component, helper, LTPortion[0]))
  component.set('v.jsonForCSV', jsonForCSV)
...
setJSONData: function (component, helper, element) {
  var userProfile = component.get('v.userProfile');
      ...
      if (userProfile == 'GroupHead' || userProfile == 'System Administrator') {
        obj['Original target (' + reportYear + '): Variance'] = (element.product != 'NIIc' || element.originVarianceFull === '') ? '' : helper.numberWithDecimal(element.originVarianceFull)
        obj['Original target (' + reportYear + '): % Archieve (YTD)'] = (element.product != 'NIIc' || element.originArchieve === '') ? '' : helper.numberWithDecimal(element.originArchieve * 100) + '%'
        obj['Original target (' + reportYear + '): FY Target'] = (element.product != 'NIIc' || element.originFYTargetFull === '') ? '' : helper.numberWithDecimal(element.originFYTargetFull)
        if (month >= 3) {
          obj['3+9F target(' + reportYear + '): Variance'] = (element.product != 'NIIc' || element.firstTargetVarianceFull === '') ? '' : helper.numberWithDecimal(element.firstTargetVarianceFull)
          obj['3+9F target (' + reportYear + '): % Archieve (YTD)'] = (element.product != 'NIIc' || element.firstTargetArchieve === '') ? '' : helper.numberWithDecimal(element.firstTargetArchieve * 100) + '%'
          obj['3+9F target (' + reportYear + '): FY Target'] = (element.product != 'NIIc' || element.firstTargetFYTargetFull === '') ? '' : helper.numberWithDecimal(element.firstTargetFYTargetFull)
        }
        if (month >= 6) {
          obj['6+6F target(' + reportYear + '): Variance'] = (element.product != 'NIIc' || element.secondTargetVarianceFull === '') ? '' : helper.numberWithDecimal(element.secondTargetVarianceFull)
          obj['6+6F target (' + reportYear + '): % Archieve (YTD)'] = (element.product != 'NIIc' || element.secondTargetArchieve === '') ? '' : helper.numberWithDecimal(element.secondTargetArchieve * 100) + '%'
          obj['6+6F target (' + reportYear + '): FY Target'] = (element.product != 'NIIc' || element.secondTargetFYTargetFull === '') ? '' : helper.numberWithDecimal(element.secondTargetFYTargetFull)
        }
        if (month >= 9) {
          obj['9+3F target(' + reportYear + '): Variance'] = (element.product != 'NIIc' || element.thirdTargetVarianceFull === '') ? '' : helper.numberWithDecimal(element.thirdTargetVarianceFull)
          obj['9+3F target (' + reportYear + '): % Archieve (YTD)'] = (element.product != 'NIIc' || element.thirdTargetArchieve === '') ? '' : helper.numberWithDecimal(element.thirdTargetArchieve * 100) + '%'
          obj['9+3F target (' + reportYear + '): FY Target'] = (element.product != 'NIIc' || element.thirdTargetFYTargetFull === '') ? '' : helper.numberWithDecimal(element.thirdTargetFYTargetFull)
        }
      }
