({
    onInit: function (component, event, helper) {
        ...
        component.set('v.APIfields', ['regisStateTable', 'e_statement', 'CYC_Campaign_PromoCond_api'].map(m => {
            return {
                'fieldName': m
            };
        }));
        ...
        // set list of section use for api field
        
        component.set('v.instantLendingFieldName',$A.get('$Label.c.Instant_Lending'));
