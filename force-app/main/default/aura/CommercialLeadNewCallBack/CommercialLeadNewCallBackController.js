({
    onInit : function(component, event, helper) {
        ...
        //check Avaya Integration Lead field
        ...
        action.setCallback(this, function (response) {
            if (component.isValid() && response.getState() === 'SUCCESS') {
                ...
                if (!result) {
                    helper.displayToast(component ,helper,'Error','error', 'This Lead is not Avaya Lead. Cannot create Call Back');
    ...
    handleReadonly : function(component, event, helper){     
        if(component.get('v.readonly'))
        {
            ...
            //component.set('v.callback_mode',null);
        }
