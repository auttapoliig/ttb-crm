({
    drawChart : function(component, event, helper) {
      // console.log('debug drawchart',this.chartJs)
        var kpi = component.get('v.kpiValue');
        var chartObj = component.get("v.chartObj"); 
        var chartNeedleObj = component.get("v.chartNeedleObj"); 
        // var chartJs = component.get('v.Chart');
        if(chartObj){
            chartObj.destroy();
        }
    ...
    var el = component.find("chart").getElement();
      ...
      chartObj = new Chart(ctx, option1); 
        ...
        // };
        // var oldNode = document.getElementById('secondContainer');
        // if(oldNode) {
        //   // console.log('DOM',document.getElementById("chartTPerfContainer"))
        //   oldNode.remove();
        // }
        ...
        // node.height = 207;
        // node.width = 136;
        // node.id = 'secondContainer';
        // document.getElementById("chartTPerfContainer").appendChild(node);
      ...
      //   var dataTotal = dataList.reduce((a, b) => a + b, 0)
        ...
        // var ctx = chart.ctx;
        // var cw = chartObj.canvas.offsetWidth;
        // var ch = chartObj.canvas.offsetHeight;
        var cw = 207; // ปรับตามขนาดของ chart width/height
        var ch = 136; // ปรับตามขนาดของ chart width/height
        var cx = cw / 2;
        var cy = ch -6;
      ...
      this.chartFillText2(ctx3,'I',16,'500',0.125*chartObj.width,0.55*chartObj.height,0);
      this.chartFillText2(ctx3,'M',16,'500',0.33*chartObj.width,0.25*chartObj.height,0);
      this.chartFillText2(ctx3,'G',16,'500',0.5*chartObj.width,0.20*chartObj.height,0);
      this.chartFillText2(ctx3,'V',16,'500',0.67*chartObj.width,0.25*chartObj.height,0);
      this.chartFillText2(ctx3,'E',16,'500',0.875*chartObj.width,0.55*chartObj.height,0);
      // this.chartFillText2(ctx3,'I',16,'500',0.125*chartObj.width,0.59*chartObj.height,0);
      // this.chartFillText2(ctx3,'M',16,'500',0.34*chartObj.width,0.28*chartObj.height,0);
      // this.chartFillText2(ctx3,'G',16,'500',0.5*chartObj.width,0.22*chartObj.height,0);
      // this.chartFillText2(ctx3,'V',16,'500',0.66*chartObj.width,0.28*chartObj.height,0);
      // this.chartFillText2(ctx3,'E',16,'500',0.875*chartObj.width,0.59*chartObj.height,0);
