({
    onInit : function(component, event, helper) {
        ...
        if(component.get('v.onQuickAction'))
        {
            ...
            helper.checkCallBackPermission(component, event, helper);
        }
        else
        {
        ...
        helper.checkIsCampaignMember(component, event, helper);
    ...
    modeChange : function(component, event, helper){
        ...
        // {
            ...
            component.set('v.callback_mode', event.currentTarget.value);
        // }

    },
    handleSubmit : function(component, event, helper){
        component.set('v.loaded',true);
        console.log('Contact status : ' + component.get("v.contactStatus"));
        var contactstatus =  component.get("v.contactStatus");
        if(contactstatus && contactstatus.includes("Do Not Contact")){
            helper.cancelCallback(component, event, helper);
        }else{   
            ...
            console.log('callback_number:',component.get('v.callback_number'));
            console.log('callback_description:',component.get('v.callback_description'));
            console.log('callback_mode:',component.get('v.callback_mode'));
            ...
            if(isExpanded)
            {
                ...
                if(component.get('v.reschedule')){
                    ...
                    {
                        helper.rescheduleCallback(component, event, helper, callback);
                    }
                    else
                    {
                        helper.rescheduleCallback(component, event, helper, function(response){});
                    }
                }
                else{
                    // console.lpog('no reschedule')
                    if(component.get('v.isCampaignMember'))
                    {
                        helper.scheduleCallback(component, event, helper, callback);
                    }
                    else{
                        helper.scheduleCallback(component, event, helper, function(response){});
                    }
                }
            }
        }
    ...
    DNCcancelCallback : function(component, event, helper){    
       helper.cancelCallback(component, event, helper);
    },
